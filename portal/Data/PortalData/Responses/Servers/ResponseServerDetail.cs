...
namespace PortalData.Responses.Servers
{
	...
	public class ResponseServerDetail : ResponseServer
	{
		/// <summary>네트워크 인터페이스 목록</summary>
		public List<ResponseNetworkInterfaceDetail> NetworkInterfaces { get; set; } = new List<ResponseNetworkInterfaceDetail>();
