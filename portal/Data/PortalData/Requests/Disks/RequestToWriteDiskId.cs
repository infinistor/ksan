...
{
	/// <summary>디스크 아이디 기록 요청 클래스</summary>
	public class RequestToWriteDiskId : CommonRequestData
	{
		/// <summary>디스크 아이디</summary>
		[Required(ErrorMessageResourceName = "EM_DISKS_REQUIRE_DISK_ID", ErrorMessageResourceType = typeof(Resource))]
