...
{
	/// <summary>특정 이름의 디스크 풀 존재여부 확인 요청 클래스</summary>
	public class RequestIsDiskPoolNameExist : CommonRequestData
	{
		...
		/// <summary>생성자</summary>
		public RequestIsDiskPoolNameExist()
		{
		...
		public RequestIsDiskPoolNameExist(string name)
		{
			this.Name = name;
		}
	}
