...
using System;
using System.Text;
using PortalData.Requests.Services.Configs.Osd;
...
{
	/// <summary>OSD 서비스에 대한 설정 요청 객체</summary>
	public class RequestServiceConfigForOsd : CommonRequestData, IRequestServiceConfig
	{
		/// <summary>데이터베이스 설정</summary>
		public RequestOsdConfigDatabase Database { get; } = new RequestOsdConfigDatabase();

		/// <summary>메시지 큐 설정</summary>
		public RequestOsdConfigMessageQueue MessageQueue { get; } = new RequestOsdConfigMessageQueue();
