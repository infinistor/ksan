...
{
	/// <summary>HA Proxy 기본 설정 요청 객체</summary>
	public class RequestHaProxyConfigDefault : RequestHaProxyConfigBase
	{
		/// <summary>섹션명</summary>
		...
		public override ResponseData<string> Serialize()
		{
			...
			try
			{
				...
				config.AppendLine($"\ttimeout connect {this.TimeoutConnect}");
				config.AppendLine($"\ttimeout client {this.TimeoutClient}");
				config.AppendLine($"\ttimeout server {this.TimeoutServer}");
