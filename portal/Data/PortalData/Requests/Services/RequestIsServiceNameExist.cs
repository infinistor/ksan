...
{
	/// <summary>특정 이름의 서비스 존재여부 확인 요청 클래스</summary>
	public class RequestIsServiceNameExist : CommonRequestData
	{
		/// <summary>서버명</summary>
		...
		/// <summary>생성자</summary>
		public RequestIsServiceNameExist()
		{
		...
		public RequestIsServiceNameExist(string name)
		{
			this.Name = name;
		}
	}
