...
{
	/// <summary>특정 이름의 서버 존재여부 확인 요청 클래스</summary>
	public class RequestIsServerNameExist : CommonRequestData
	{
		/// <summary>서버명</summary>
		...
		/// <summary>생성자</summary>
		public RequestIsServerNameExist()
		{
		...
		public RequestIsServerNameExist(string name)
		{
			this.Name = name;
		}
	}
