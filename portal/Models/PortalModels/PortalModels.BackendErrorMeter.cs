...
{
	public partial class BackendErrorMeter
	{

		public BackendErrorMeter()
		{
			OnCreated();
		}

		/// <summary> 저장시간 </summary>
		...
		public virtual long ClientErrorCount { get; set; }

		public virtual long ServerErrorCount { get; set; }
		...
		{
			BackendErrorMeter toCompare = obj as BackendErrorMeter;
			if (toCompare == null)
			{
				return false;
			}
