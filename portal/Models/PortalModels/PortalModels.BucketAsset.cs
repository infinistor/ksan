...
namespace PortalModels
{
	...
	public partial class BucketAsset
	{
		...
		public virtual long MaxUsed { get; set; }

		public virtual long MinUsed { get; set; }

		public virtual long? AvgUsed { get; set; }
		...
		{
			BucketAsset toCompare = obj as BucketAsset;
			if (toCompare == null)
			{
				return false;
			}
