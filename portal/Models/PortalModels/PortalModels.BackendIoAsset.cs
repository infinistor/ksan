...
{
	/// <summary> 버킷 IO 로그 </summary>
	public partial class BackendIoAsset
	{

		public BackendIoAsset()
		{
			OnCreated();
		}
		...
		/// <summary> 업로드 용량 </summary>
		public virtual long Upload { get; set; }

		/// <summary> 다운로드 용량 </summary>
		public virtual long Download { get; set; }
		...
		{
			BackendIoAsset toCompare = obj as BackendIoAsset;
			if (toCompare == null)
			{
				return false;
			}
