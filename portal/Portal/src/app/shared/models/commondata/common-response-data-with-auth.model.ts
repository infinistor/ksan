...
export class CommonResponseDataWithAuth<T = any> extends CommonResponseData<T> {
	 ...
	 * @param Data 데이터 객체
	 */
	constructor(IsNeedLogin?: boolean, AccessDenied?: boolean, Result: EnumResponseResult = EnumResponseResult.Error, Code: string = '', Message: string = '', Data: T = null) {
