...
public class KsanGetObjectTagging extends S3Request {
    public KsanGetObjectTagging(S3Parameter s3Parameter) {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(KsanGetObjectTagging.class);
	}
