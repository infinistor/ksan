...
public class KsanGetObject extends S3Request implements S3AddResponse {
    public KsanGetObject(S3Parameter s3Parameter) {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(KsanGetObject.class);
	}
