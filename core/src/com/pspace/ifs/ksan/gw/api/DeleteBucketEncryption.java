...
public class DeleteBucketEncryption extends S3Request {

    public DeleteBucketEncryption(S3Parameter s3Parameter) {
        super(s3Parameter);
    ...
    public void process() throws GWException {
        logger.info(GWConstants.LOG_DELETE_BUCKET_ENCRYPTION_START);
