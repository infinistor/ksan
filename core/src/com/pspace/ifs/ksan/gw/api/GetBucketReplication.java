...
public class GetBucketReplication extends S3Request {
    public GetBucketReplication(S3Parameter s3Parameter) {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(GetBucketReplication.class);
    }
    ...
    public void process() throws GWException {
        ...
        try {
			if (!Strings.isNullOrEmpty(replication)) {
				...
				s3Parameter.getResponse().getOutputStream().write(replication.getBytes(Charset.forName(Constants.UTF_8)));
			}
		} catch (IOException e) {
