...
public class S3RequestFactory {
	...
	private final String OP_DELETE_BUCKET_INVENTORY = "REST.DELETE.BUCKET.INVENTORY";
	...
	private final String OP_GET_BUCKET_INVENTORY = "REST.GET.BUCKET.INVENTORY";
	private final String OP_GET_LISTBUCKETINVENTORY = "REST.GET.LISTBUCKETINVENTORY";
	...
	private final String OP_PUT_BUCKET_NOTIFICATION = "REST.PUT.BUCKET.NOTIFICATION";
	private final String OP_PUT_BUCKET_INVENTORY = "REST.PUT.BUCKET.INVENTORY";
	...
	private final String OP_ADMIN_GET_BUCKET_ACL = "BACKEND.GET.BUCKET.ACL";
	private final String OP_ADMIN_DELETE_OBJECT = "BACKEND.DELETE.OBJECT";
	private final String OP_ADMIN_DELETE_OBJECT_TAGGING = "BACKEND.DELETE.OBJECT.TAGGING";
	private final String OP_ADMIN_DELETE_OBJECT_UPLOAD = "BACKEND.DELETE.OBJECT.UPLOAD";
	private final String OP_ADMIN_GET_OBJECT_ACL = "BACKEND.GET.OBJECT.ACL";
	private final String OP_ADMIN_GET_OBJECT_TAGGING = "BACKEND.GET.OBJECT.TAGGING";
	private final String OP_ADMIN_GET_OBJECT = "BACKEND.GET.OBJECT";
	private final String OP_ADMIN_HEAD_OBJECT = "BACKEND.HEAD.OBJECT";
	private final String OP_ADMIN_POST_UPLOAD = "BACKEND.POST.UPLOAD";
	private final String OP_ADMIN_POST_COMPLETE = "BACKEND.POST.COMPLETEUPLOAD";
	private final String OP_ADMIN_PUT_OBJECT_ACL = "BACKEND.PUT.OBJECT.ACL";
	private final String OP_ADMIN_PUT_OBJECT_TAGGING = "BACKEND.PUT.OBJECT.TAGGING";
	private final String OP_ADMIN_PUT_OBJECT = "BACKEND.PUT.OBJECT";
	private final String OP_ADMIN_PUT_OBJECT_PART = "BACKEND.PUT.OBJECT.PART";
	private final String OP_ADMIN_PUT_OBJECT_PART_COPY = "BACKEND.PUT.OBJECT.PART.COPY";
	private final String OP_ADMIN_PUT_RESTORE_OBJECT = "BACKEND.POST.RESTORE.OBJECT";
	private final String OP_ADMIN_PUT_STORAGE_MOVE = "BACKEND.STORAGE.MOVE";
		...
		switch (s3Parameter.getMethod()) {
			case GWConstants.METHOD_DELETE:
				if (GWConstants.CATEGORY_BUCKET.equals(s3Parameter.getPathCategory())) {
					...
					} else if (GWConstants.EMPTY_STRING.equals(s3Parameter.getRequest().getParameter(GWConstants.PARAMETER_INVENTORY))) {
						s3Parameter.setOperation(OP_DELETE_BUCKET_INVENTORY);
						return new DeleteBucketInventory(s3Parameter);
					}
			...
			case GWConstants.METHOD_GET:
				...
				if (GWConstants.CATEGORY_BUCKET.equals(s3Parameter.getPathCategory())) {
					if (GWConstants.EMPTY_STRING.equals(s3Parameter.getRequest().getParameter(GWConstants.PARAMETER_WEBSITE))) {
						...
						String id = s3Parameter.getRequest().getParameter(GWConstants.PARAMETER_ID);
						if (id != null) {
							s3Parameter.setOperation(OP_GET_BUCKET_INVENTORY);
							return new GetBucketInventory(s3Parameter);
						} else {
							s3Parameter.setOperation(OP_GET_LISTBUCKETINVENTORY);
							return new ListBucketInventory(s3Parameter);
						}
					}
			...
			case GWConstants.METHOD_PUT:
				if (GWConstants.CATEGORY_BUCKET.equals(s3Parameter.getPathCategory())) {
					if (GWConstants.EMPTY_STRING.equals(s3Parameter.getRequest().getParameter(GWConstants.PARAMETER_WEBSITE))) {
						...
						s3Parameter.setOperation(OP_PUT_BUCKET_INVENTORY);
						return new PutBucketInventory(s3Parameter);
					}
