...
public class DeleteBucketWebsite extends S3Request {
    public DeleteBucketWebsite(S3Parameter s3Parameter) {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DeleteBucketWebsite.class);
	}
