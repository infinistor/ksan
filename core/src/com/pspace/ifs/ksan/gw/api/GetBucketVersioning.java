...
public class GetBucketVersioning extends S3Request {
	...
	public void process() throws GWException {		
		...
		if (!checkPolicyBucket(GWConstants.ACTION_GET_BUCKET_VERSIONING, s3Parameter)) {
		...
		try {
			...
			s3Parameter.getResponse().getOutputStream().write(xml.getBytes(Charset.forName(Constants.UTF_8)));
		} catch (IOException e) {
