...
public class GCSDeleteObject extends GCSRequest {

    public GCSDeleteObject(S3Parameter s3Parameter) {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(GCSDeleteObject.class);
    }

    @Override
    public void process() throws GWException {
        logger.info(GWConstants.LOG_GCS_DELETE_OBJECT_START);
