...
public class PutBucketInventory extends S3Request {
    ...
    public PutBucketInventory(S3Parameter ip) {
		super(ip);
	...
	public void process() throws GWException {
		...
		if (!checkPolicyBucket(GWConstants.ACTION_PUT_INVENTORY_CONFIGURATION, s3Parameter)) {
			checkGrantBucket(true, GWConstants.GRANT_WRITE_ACP);
		}

		String inventoryXml = s3RequestData.getInventoryXml();
		logger.info(GWConstants.LOG_PUT_BUCKET_INVENTORY_XML, inventoryXml);
		updateBucketInventory(bucket, inventoryXml);
