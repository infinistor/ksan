...
public class GetBucketEncryption extends S3Request {

    public GetBucketEncryption(S3Parameter s3Parameter) {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(GetBucketEncryption.class);
    }
    ...
    public void process() throws GWException {
		...
		try {
			if (!Strings.isNullOrEmpty(encryption)) {
				...
				s3Parameter.getResponse().getOutputStream().write(encryption.getBytes(Charset.forName(Constants.UTF_8)));
			}
		} catch (IOException e) {
