...
public class DataPutObjectAcl extends S3DataRequest {
	...
	public DataPutObjectAcl(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataPutObjectAcl.class);
		hasAclKeyword = false;
	}
