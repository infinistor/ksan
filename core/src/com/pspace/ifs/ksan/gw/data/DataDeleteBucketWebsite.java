...
public class DataDeleteBucketWebsite extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataDeleteBucketWebsite(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeleteBucketWebsite.class);
	}
