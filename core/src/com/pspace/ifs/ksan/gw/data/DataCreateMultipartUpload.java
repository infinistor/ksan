...
public class DataCreateMultipartUpload extends S3DataRequest {
	...
	public DataCreateMultipartUpload(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		userMetadata = new TreeMap<String, String>();
		logger = LoggerFactory.getLogger(DataCreateMultipartUpload.class);
		hasAclKeyword = false;
	}
