...
public class DataDeleteBucketPolicy extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataDeleteBucketPolicy(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeleteBucketPolicy.class);
	}
