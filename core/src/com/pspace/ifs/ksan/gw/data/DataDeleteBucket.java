...
public class DataDeleteBucket extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataDeleteBucket(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeleteBucket.class);
	}
