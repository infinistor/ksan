...
public class DataPutBlock extends AzuDataRequest {
    private String blockid;

    public DataPutBlock(AzuParameter parameter) throws AzuException {
        super(parameter);
        logger = LoggerFactory.getLogger(DataPutBlock.class);
    }
