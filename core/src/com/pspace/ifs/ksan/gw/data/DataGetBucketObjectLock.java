...
public class DataGetBucketObjectLock extends S3DataRequest {
    private String expectedBucketOwner;

    public DataGetBucketObjectLock(S3Parameter s3Parameter) throws GWException {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(DataGetBucketObjectLock.class);
    }
