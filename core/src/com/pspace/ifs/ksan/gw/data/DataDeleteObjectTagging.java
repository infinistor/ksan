...
public class DataDeleteObjectTagging extends S3DataRequest {
	private String versionId;
	private String expectedBucketOwner;
	
	public DataDeleteObjectTagging(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeleteObjectTagging.class);
	}
