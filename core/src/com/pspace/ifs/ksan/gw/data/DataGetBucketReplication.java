...
public class DataGetBucketReplication extends S3DataRequest {
    private String expectedBucketOwner;

    public DataGetBucketReplication(S3Parameter s3Parameter) throws GWException {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(DataGetBucketReplication.class);
    }
