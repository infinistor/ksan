...
public class DataDeleteContainer extends AzuDataRequest {

    public DataDeleteContainer(AzuParameter parameter) throws AzuException {
        super(parameter);
        logger = LoggerFactory.getLogger(DataDeleteContainer.class);
    }
