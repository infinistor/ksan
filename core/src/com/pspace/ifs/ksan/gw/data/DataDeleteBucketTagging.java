...
public class DataDeleteBucketTagging extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataDeleteBucketTagging(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeleteBucketTagging.class);
	}
