...
public class DataGetBucketTagging extends S3DataRequest {
    private String expectedBucketOwner;

    public DataGetBucketTagging(S3Parameter s3Parameter) throws GWException {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(DataGetBucketTagging.class);
    }
