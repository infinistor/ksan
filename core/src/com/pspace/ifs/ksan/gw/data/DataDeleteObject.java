...
public class DataDeleteObject extends S3DataRequest {
	...
	public DataDeleteObject(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeleteObject.class);
	}
