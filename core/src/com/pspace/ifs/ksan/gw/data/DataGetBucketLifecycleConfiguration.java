...
public class DataGetBucketLifecycleConfiguration extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataGetBucketLifecycleConfiguration(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataGetBucketLifecycleConfiguration.class);
	}
