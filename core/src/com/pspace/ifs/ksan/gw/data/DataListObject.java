...
public class DataListObject extends S3DataRequest {
	...
	public DataListObject(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataListObject.class);
	}
	...
	public void extract() throws GWException {
		...
		for (String headerName : Collections.list(s3Parameter.getRequest().getHeaderNames())) {
			if (headerName.equalsIgnoreCase(GWConstants.X_AMZ_REQUEST_S3_GET_PAYER)) {
