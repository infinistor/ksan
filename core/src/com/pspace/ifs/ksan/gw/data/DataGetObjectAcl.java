...
public class DataGetObjectAcl extends S3DataRequest {
	private String versionId;
	private String requestPayer;
	private String expectedBucketOwner;
	
	public DataGetObjectAcl(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataGetObjectAcl.class);
	}
