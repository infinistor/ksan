...
public class DataGetBlob extends AzuDataRequest {

    public DataGetBlob(AzuParameter parameter) throws AzuException {
        super(parameter);
        logger = LoggerFactory.getLogger(DataGetBlob.class);
    }
