...
public class DataDeleteBucketCors extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataDeleteBucketCors(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeleteBucketCors.class);
	}
