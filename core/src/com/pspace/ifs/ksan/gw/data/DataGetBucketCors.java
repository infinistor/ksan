...
public class DataGetBucketCors extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataGetBucketCors(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataGetBucketCors.class);
	}
