...
public class DataListBuckets extends S3DataRequest {
	...
	public DataListBuckets(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataListBuckets.class);
	}
