...
public class DataHeadBlob extends AzuDataRequest {

    public DataHeadBlob(AzuParameter parameter) throws AzuException {
        super(parameter);
        logger = LoggerFactory.getLogger(DataHeadBlob.class);
    }
