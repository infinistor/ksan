...
public class DataPutBucketVersioning extends S3DataRequest {
	private String contentMD5;
	private String mfa;
	private String expectedBucketOwner;
	private String versioningXml;
	
	public DataPutBucketVersioning(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataPutBucketVersioning.class);
	}
