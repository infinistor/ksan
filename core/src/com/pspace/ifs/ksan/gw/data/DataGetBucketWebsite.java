...
public class DataGetBucketWebsite extends S3DataRequest {
    private String expectedBucketOwner;

    public DataGetBucketWebsite(S3Parameter s3Parameter) throws GWException {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(DataGetBucketWebsite.class);
    }
