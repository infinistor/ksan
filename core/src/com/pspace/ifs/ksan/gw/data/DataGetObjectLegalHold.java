...
public class DataGetObjectLegalHold extends S3DataRequest {
    private String versionId;
	private String requestPayer;
	private String expectedBucketOwner;

    public DataGetObjectLegalHold(S3Parameter s3Parameter) throws GWException {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(DataGetObjectLegalHold.class);
    }
