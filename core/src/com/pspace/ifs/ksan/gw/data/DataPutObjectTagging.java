...
public class DataPutObjectTagging extends S3DataRequest {
	...
	public DataPutObjectTagging(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataPutObjectTagging.class);
	}
