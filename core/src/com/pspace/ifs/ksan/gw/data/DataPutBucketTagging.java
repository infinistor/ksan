...
public class DataPutBucketTagging extends S3DataRequest {
    private String contentMD5;
	private String expectedBucketOwner;
	private String taggingXml;
	
	public DataPutBucketTagging(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataPutBucketTagging.class);
	}
