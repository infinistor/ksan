...
public class DataGetBucketLogging extends S3DataRequest {
    private String expectedBucketOwner;
	
	public DataGetBucketLogging(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataGetBucketLogging.class);
	}
