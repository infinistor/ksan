...
public class DataPutBucketEncryption extends S3DataRequest {
    private String contentMD5;
	private String expectedBucketOwner;
	private String encryptionXml;
    
    public DataPutBucketEncryption(S3Parameter s3Parameter) throws GWException {
        super(s3Parameter);
        logger = LoggerFactory.getLogger(DataPutBucketEncryption.class);
    }
