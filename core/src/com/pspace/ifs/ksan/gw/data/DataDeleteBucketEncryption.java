...
public class DataDeleteBucketEncryption extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataDeleteBucketEncryption(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeleteBucketEncryption.class);
	}
