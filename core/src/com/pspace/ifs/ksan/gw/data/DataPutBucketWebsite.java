...
public class DataPutBucketWebsite extends S3DataRequest {
    private String contentMD5;
	private String expectedBucketOwner;
	private String websiteXml;
	
	public DataPutBucketWebsite(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataPutBucketWebsite.class);
	}
