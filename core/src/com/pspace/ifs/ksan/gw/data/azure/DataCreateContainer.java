...
public class DataCreateContainer extends AzuDataRequest {

    public DataCreateContainer(AzuParameter parameter) throws AzuException {
        super(parameter);
        logger = LoggerFactory.getLogger(DataCreateContainer.class);
    }
