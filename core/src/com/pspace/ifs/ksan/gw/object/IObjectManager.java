...
public interface IObjectManager {
    void getObject(S3Parameter param, Metadata meta, S3Encryption en, S3Range range) throws GWException;
    S3Object putObject(S3Parameter param, Metadata meta, S3Encryption en) throws GWException;
