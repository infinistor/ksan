...
public enum GWErrorCode {
    ...
    INVALID_CONFIGURATION_ID(HttpServletResponse.SC_BAD_REQUEST, "Bad Request"),
    ...
    NO_SUCH_CONFIGURATION(HttpServletResponse.SC_NOT_FOUND,
            "The specified bucket does not have a analytics configuration"),
    NO_SUCH_ACCELERATE_CONFIGURATION(HttpServletResponse.SC_NOT_FOUND,
            "The specified bucket does not have a accelerate configuration"),
    NO_SUCH_PAYMENT_CONFIGURATION(HttpServletResponse.SC_NOT_FOUND,
            "The specified bucket does not have a request payment configuration"),       
