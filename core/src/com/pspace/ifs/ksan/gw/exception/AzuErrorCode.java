...
public enum AzuErrorCode {
    ...
    INVALID_ACCOUNT(HttpServletResponse.SC_BAD_REQUEST, "Invalid storage account."),
    CONTAINER_ALREADY_EXISTS(HttpServletResponse.SC_CONFLICT,
            "The requested container name is not available." +
            " The container namespace is shared by all users of the system." +
    ...
    INVALID_STORAGE_ACCOUNT(HttpServletResponse.SC_BAD_REQUEST, "Invalid storage account."),
    ...
    MISSING_CONTENT_LENGTH(HttpServletResponse.SC_LENGTH_REQUIRED,
            "Length Required"),
    NO_SUCH_CONTAINER(HttpServletResponse.SC_NOT_FOUND,
    ...
    AzuErrorCode(int httpStatusCode, String message) {
