...
public class NumericLessThanEquals extends PolicyCondition {
    public NumericLessThanEquals(JsonNode jsonNode) {
        super(jsonNode);
        logger = LoggerFactory.getLogger(NumericLessThanEquals.class);
    }
