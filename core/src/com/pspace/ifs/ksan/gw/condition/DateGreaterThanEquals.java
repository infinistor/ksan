...
public class DateGreaterThanEquals extends PolicyCondition {
    public DateGreaterThanEquals(JsonNode jsonNode) {
        super(jsonNode);
        logger = LoggerFactory.getLogger(DateGreaterThanEquals.class);
    }
