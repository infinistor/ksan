...
public class NumericGreaterThan extends PolicyCondition {
    public NumericGreaterThan(JsonNode jsonNode) {
        super(jsonNode);
        logger = LoggerFactory.getLogger(NumericGreaterThan.class);
    }
