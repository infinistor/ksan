...
public class StringNotEqualsIgnoreCase extends PolicyCondition {
    public StringNotEqualsIgnoreCase(JsonNode jsonNode) {
        super(jsonNode);
        logger = LoggerFactory.getLogger(StringNotEqualsIgnoreCase.class);
    }
                ...
                if (tagging != null) {
                    if (tagging.tagset != null && tagging.tagset.tags != null) {
                        for (Tag t : tagging.tagset.tags) {
                            ...
                            if (!t.key.equalsIgnoreCase(tagkey) && !t.value.equalsIgnoreCase(tagvalue)) {
                                conditioncheck = true;
                                break;
                            }
                        }
