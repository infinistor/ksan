...
public class NumericGreaterThanEquals extends PolicyCondition {
    public NumericGreaterThanEquals(JsonNode jsonNode) {
        super(jsonNode);
        logger = LoggerFactory.getLogger(NumericGreaterThanEquals.class);
    }
