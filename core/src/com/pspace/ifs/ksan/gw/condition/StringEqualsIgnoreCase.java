...
public class StringEqualsIgnoreCase extends PolicyCondition {
    public StringEqualsIgnoreCase(JsonNode jsonNode) {
        super(jsonNode);
        logger = LoggerFactory.getLogger(StringEqualsIgnoreCase.class);
    }
