	...
	public void init() throws Exception {
		if (Sender == null)
			Sender = new MQSender(Config.MQHost, Config.MQPort, Config.MQUser, Config.MQPassword,
					Constants.MQ_KSAN_LOG_EXCHANGE, Constants.MQ_EXCHANGE_OPTION_TOPIC, "");
	}

	public void Send(String Message, String bindingKey) throws Exception {
		Sender.send(Message, bindingKey);
	}
}
