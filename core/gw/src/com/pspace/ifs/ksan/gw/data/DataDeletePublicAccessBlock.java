...
public class DataDeletePublicAccessBlock extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataDeletePublicAccessBlock(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataDeletePublicAccessBlock.class);
	}
