...
public class DataGetBucketEncryption extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataGetBucketEncryption(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataGetBucketEncryption.class);
	}
