...
public class DataAbortMultipartUpload extends S3DataRequest {
	private String uploadId;

	private String requestPayer;
	private String expectedBucketOwner;
	
	public DataAbortMultipartUpload(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataAbortMultipartUpload.class);
	}
