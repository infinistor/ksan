...
public class DataHeadBucket extends S3DataRequest {
	private String expectedBucketOwner;
	
	public DataHeadBucket(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataHeadBucket.class);
	}
