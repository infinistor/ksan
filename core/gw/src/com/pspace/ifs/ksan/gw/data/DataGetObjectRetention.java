...
public class DataGetObjectRetention extends S3DataRequest {
    private String versionId;
	private String requestPayer;
	private String expectedBucketOwner;
	
	public DataGetObjectRetention(S3Parameter s3Parameter) throws GWException {
		super(s3Parameter);
		logger = LoggerFactory.getLogger(DataGetObjectRetention.class);
	}
